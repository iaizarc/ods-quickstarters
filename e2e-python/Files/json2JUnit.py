...
output_path = "great_expectations/uncommitted/validations/person_validation_suite/junit.xml"
jsons_path = "great_expectations/uncommitted/validations/person_validation_suite/**/*.json"

json_files = glob.glob(jsons_path, recursive=True)
